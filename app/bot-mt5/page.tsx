  ...
  return (
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold">Mi EA MT5</h1>
              ...
              <tbody>
                {trades.map((trade) => (
                  <tr key={trade.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-right font-mono">{trade.entry.toFixed(5)}</td>
                    ...
                    <td className={`py-3 px-4 text-right font-bold ${trade.pnl! > 0 ? "text-green-600" : "text-red-600"}`}>
